...
| Run a repo with only a deployed site | ✅ | `RunHostedSiteUITests`; `docs/screenshots/running-hosted.png` |
...
- **Last release:** v0.3.0 — 2026-09-02.
- **Not verified:** the run path is proven on the iOS simulator and the
  app itself is installed on a physical iPhone, but Run has not been
  exercised there by me. The runner has no simulator-specific branch,
